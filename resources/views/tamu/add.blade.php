    ...
    <div class="container">
        ...
        <form action="{{ url('/tamu') }}" method="POST">
            ...
            <div class="mb-3 w-50">
                ...
                <input type="text" class="form-control" name="nim_tamu">
            </div>
            <div class="mb-3 w-50">
            ...
            <div class="mb-2 w-50">
                <label>JURUSAN</label>
                <select class="form-control" name="jurusan_tamu">
                ...
                <input type="text" class="form-control" name="tanggal_kunjung">
            </div>
            <br>
            <div class="mb-3">
                <button type="submit" class="btn btn-primary mb-1" value="SIMPAN">
